...
#SBATCH -o logs/%j-Needle-SFT-TTT.out.log
#SBATCH -e logs/%j-Needle-SFT-TTT.err.log
#SBATCH -c 1

python scripts/prediction_needle.py \
    --haystack_path datasets/needle/PaulGrahamEssays \
    --output_path outputs/Needle-SFT-TTT.json \
    --overwrite False \
    ...
    --model_name_or_path models/sft-needle-stage2 \
