...
#SBATCH -o logs/%j-QualitySent-SFTSent-TTTwQA-out.log
#SBATCH -e logs/%j-QualitySent-SFTSent-TTTwQA-err.log
#SBATCH -c 1
...
python scripts/prediction_quality_sent.py \
    ...
    --output_file outputs/QualitSent-SFTSent-TTTwQA.json \
    --overwrite True \
