...
#SBATCH -o logs/%j-quality-sent-test-ttt-w-qa.out.log
#SBATCH -e logs/%j-quality-sent-test-ttt-w-qa.err.log
#SBATCH -c 1

python scripts/prediction_quality_sent.py \
    --model_name_or_path models/Meta-Llama-3-8B-Instruct \
    --model_max_length 7900 \
    --output_file outputs/quality-sent-test-ttt-w-qa.json \
