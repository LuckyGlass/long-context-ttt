...
#SBATCH -o logs/%j-QuALITYSent-SFTSent-FullTTTwQA.out.log
#SBATCH -e logs/%j-QuALITYSent-SFTSent-FullTTTwQA.err.log
#SBATCH -c 1
...
python scripts/prediction_quality_sent.py \
    ...
    --output_file outputs/QuALITYSent-SFTSent-FullTTTwQA.json \
    --overwrite True \
