...
#SBATCH -o logs/quality-epoch28-time24-lr1e-6-%j-out.log
#SBATCH -e logs/quality-epoch28-time24-lr1e-6-%j-err.log
#SBATCH -c 1
...
python scripts/prediction_quality.py \
    ...
    --output_file outputs/tune/quality-epoch28-time24-lr1e-6.json \
    --enable_ICL True \
    --ttt_enable_ICL True \
    --recite_first False \
